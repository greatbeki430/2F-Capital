...
class _ChatRoomState extends State<ChatRoom> {
  ...
  void _searchMessages(String query) {
    ...
    // Assuming messages is your original list of messages fetched from Firebase
    final allMessages = _messages; // This should be your original message list
  ...
  Widget _buildMessageItem(Map<dynamic, dynamic> message) {
    ...
    return Container(
      margin: EdgeInsets.only(
        top: 8.0,
        bottom: 8.0,
        left: isMe ? 50.0 : 10.0, // Adjust left margin for current user
        right: isMe ? 10.0 : 50.0, // Adjust right margin for other users
      ),
      alignment:
          ...
          Expanded(
            child: StreamBuilder<DatabaseEvent>(
              ...
              builder: (context, AsyncSnapshot<DatabaseEvent> snapshot) {
                ...
                // Use filtered messages if search is active
